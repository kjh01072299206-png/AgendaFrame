  ...
  const rss = `<?xml version="1.0" encoding="UTF-8"?>
    <rss><channel>
      ...
      <item>
        ...
        <link>https://www.khan.co.kr/article/202608121200003</link>
...
test("caps a large source feed per run and keeps the newest records", async () => {
  ...
  boundedPolicy.collectionWindow.startDate = "2026-08-10";
...
test("rechecks at most the configured three KST publication dates", () => {
  const khan = source("khan");
  const recheckPolicy = structuredClone(policy);
  recheckPolicy.collectionWindow.startDate = "2026-08-10";
